...
// Type: TRCC.DCUserControl.UCComboBoxA
...
public class UCComboBoxA : UserControl
{
  private const int buttonH0 = 24;
  private const int buttonH1 = 24;
  private const int buttonHA = 192 /*0xC0*/;
  private const int buttonHAA = 216;
  private int imageX = 0;
  private int imageY = 24;
  public Image pointImg = (Image) Resources.A2下拉框底图;
  private readonly Color color1 = Color.White;
  private readonly Color color2 = Color.Silver;
  public int myMode = 1;
  public int myCount = 8;
  ...
  public UCComboBoxA.delegateUCComboBoxA ucComboBoxA;
  ...
  private void button1_Click(object sender, EventArgs e)
  {
    ...
    UCComboBoxA.delegateUCComboBoxA ucComboBoxA = this.ucComboBoxA;
    if (ucComboBoxA == null)
      return;
    ucComboBoxA(this.myMode);
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.button2.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button2.ForeColor = Color.Silver;
    this.button2.Location = new Point(0, 48 /*0x30*/);
    this.button2.Margin = new Padding(0);
    this.button2.Name = "button2";
    this.button2.Size = new Size(108, 24);
    this.button2.TabIndex = 82;
    this.button2.Text = "主题2";
    ...
    this.button1.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button1.ForeColor = Color.Silver;
    this.button1.Location = new Point(0, 24);
    this.button1.Margin = new Padding(0);
    this.button1.Name = "button1";
    this.button1.Size = new Size(108, 24);
    this.button1.TabIndex = 81;
    this.button1.Text = "主题1";
    ...
    this.button0.BackgroundImage = (Image) Resources.A2下拉选择框;
    ...
    this.button0.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button0.ForeColor = Color.Silver;
    this.button0.Location = new Point(0, 0);
    this.button0.Margin = new Padding(0);
    this.button0.Name = "button0";
    this.button0.Size = new Size(108, 24);
    this.button0.TabIndex = 80 /*0x50*/;
    this.button0.Text = "主题1";
    this.button0.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button3.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button3.ForeColor = Color.Silver;
    this.button3.Location = new Point(0, 72);
    this.button3.Margin = new Padding(0);
    this.button3.Name = "button3";
    this.button3.Size = new Size(108, 24);
    this.button3.TabIndex = 83;
    this.button3.Text = "主题3";
    this.button3.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button4.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button4.ForeColor = Color.Silver;
    this.button4.Location = new Point(0, 96 /*0x60*/);
    this.button4.Margin = new Padding(0);
    this.button4.Name = "button4";
    this.button4.Size = new Size(108, 24);
    this.button4.TabIndex = 84;
    this.button4.Text = "主题4";
    this.button4.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button5.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button5.ForeColor = Color.Silver;
    this.button5.Location = new Point(0, 120);
    this.button5.Margin = new Padding(0);
    this.button5.Name = "button5";
    this.button5.Size = new Size(108, 24);
    this.button5.TabIndex = 85;
    this.button5.Text = "主题5";
    this.button5.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button6.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button6.ForeColor = Color.Silver;
    this.button6.Location = new Point(0, 144 /*0x90*/);
    this.button6.Margin = new Padding(0);
    this.button6.Name = "button6";
    this.button6.Size = new Size(108, 24);
    this.button6.TabIndex = 86;
    this.button6.Text = "主题6";
    this.button6.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button7.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button7.ForeColor = Color.Silver;
    this.button7.Location = new Point(0, 168);
    this.button7.Margin = new Padding(0);
    this.button7.Name = "button7";
    this.button7.Size = new Size(108, 24);
    this.button7.TabIndex = 87;
    this.button7.Text = "主题7";
    this.button7.TextAlign = ContentAlignment.TopLeft;
    ...
    this.button8.Font = new Font("微软雅黑", 9f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.button8.ForeColor = Color.Silver;
    this.button8.Location = new Point(0, 192 /*0xC0*/);
    this.button8.Margin = new Padding(0);
    this.button8.Name = "button8";
    this.button8.Size = new Size(108, 24);
    this.button8.TabIndex = 88;
    this.button8.Text = "主题8";
    this.button8.TextAlign = ContentAlignment.TopLeft;
  ...
  public delegate void delegateUCComboBoxA(int mode);
}
