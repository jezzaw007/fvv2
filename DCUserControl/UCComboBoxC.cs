...
// Type: TRCC.DCUserControl.UCComboBoxC
...
public class UCComboBoxC : UserControl
{
  ...
  public Image pointImg = (Image) Resources.D下拉菜单2;
  ...
  public UCComboBoxC.delegateucComboBoxC ucComboBoxC;
  ...
  {
    base.OnPaint(pe);
    pe.Graphics.DrawImage(this.pointImg, new Rectangle(this.imageX, this.imageY, this.pointImg.Width, 24 * this.myCount));
  }
  ...
  private void button1_Click(object sender, EventArgs e)
  {
    ...
    UCComboBoxC.delegateucComboBoxC ucComboBoxC = this.ucComboBoxC;
    if (ucComboBoxC == null)
      return;
    ucComboBoxC(this.myMode);
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.button2.Size = new Size(180, 24);
    ...
    this.button1.Size = new Size(180, 24);
    ...
    this.button0.BackgroundImage = (Image) Resources.D下拉框2;
    ...
    this.button0.Size = new Size(180, 24);
    ...
    this.button3.Size = new Size(180, 24);
    ...
    this.button4.Size = new Size(180, 24);
    ...
    this.button5.Size = new Size(180, 24);
    ...
    this.button6.Size = new Size(180, 24);
    ...
    this.button7.Size = new Size(180, 24);
    ...
    this.button8.Size = new Size(180, 24);
    ...
    this.Name = nameof (UCComboBoxC);
    this.Size = new Size(180, 24);
    this.ResumeLayout(false);
  }

  public delegate void delegateucComboBoxC(int mode);
}
