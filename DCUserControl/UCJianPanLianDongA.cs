...
// Type: TRCC.DCUserControl.UCJianPanLianDongA
...
public class UCJianPanLianDongA : UserControl
{
  ...
  public UCJianPanLianDongA() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    this.buttonYL1.TabIndex = 658;
    this.buttonYL1.UseVisualStyleBackColor = false;
    this.AutoScaleMode = AutoScaleMode.Inherit;
    this.BackColor = Color.Transparent;
    this.BackgroundImage = (Image) Resources.P01键盘联动1;
    ...
    this.Name = nameof (UCJianPanLianDongA);
